...
> wsong83:<br>
> 我现在的理解硬件PTW其实就是简单的状态机去搜索页表，其实没设么特别的设计。这一节先放这里，也许去掉。
...
> 这一节建议去掉。<br>
> leishangwen:<br>
> RISC-V的优势除了open，应该还有其他优势，比如在指令结构的设计上，而指令结构设计的优势就体现在能更好的实现解码、实现指令功能，所以这里说要对Rocket的指令解码过程分析，集合具体的处理器实现，更能讲的明白。当然，具体细节我不了解，还需要明白的人来写。如果实在不好结合Rocket讲RISC-V的优势，那么就放在2.2节吧。
