...
大概有这么几个方面：概述基于RISC-V指令集的开源处理器、开源SoC、商业处理器、商业SoC，最后进行一个简单地统计分析汇总。（我之前整理过这方面的资料）

# 第四章 Chisel简介

简单介绍Chisel3.0的相关知识点。（我之前整理过Chisel2.0版本的资料）
...
第二部分介绍Rocket，包括性能参数、结构框图、接口图、各个文件的作用，
